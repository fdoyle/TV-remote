    ...
    <device>
        ...
        <serviceList>
            <service>
                ...
                <serviceType>urn:lacronicus</serviceType>
                <serviceId>urn:lacronicus</serviceId>
                <controlURL>/lacronicus</controlURL>
                <eventSubURL/>
                <SCPDURL>/remote_wsd.xml</SCPDURL>
            </service>
        </serviceList>
...
class UPNPHTTPServer(threading.Thread):
    ...
    def run(self):
        print("running xml provider forever")
